  ...
  sections: [
    ...
    // ----- Body section with header/footer + margins -----
    {
      ...
      children: [
        ...
        bullet('Structured screening — Rigorous conversations and reference validation before any candidate reaches your desk.'),
        ...
        bullet('Interview & offer support — Facilitation through interviews, offer negotiation, references, and onboarding hand-over.'),
        ...
        body('Timelines are role-dependent, but as a general guide:'),
        bullet('Weeks 0–1 — Terms accepted, engagement fee received, formal briefs taken'),
        bullet('Weeks 1–3 — Active search and screening'),
        bullet('Weeks 3–5 — Shortlist submitted, interviews facilitated'),
        bullet('Weeks 5–7 — Offer, acceptance, onboarding support'),
